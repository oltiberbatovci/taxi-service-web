    ...
    <section id="nav-bar">
        ...
        <nav class="navbar navbar-expand-lg bg-body-tertiary">
            <div class="container-fluid">
              <a class="navbar-logo" href="homeAdmin.php">ThirreTaxin</a>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <h1 class="welcome" style="text-align:center;font-size:13px;">Welcome Admin : <span><?php echo $_SESSION['name'] ?></span></h1>
                </div>
                <div id="kontenti">
                  <header>
                  <img id="slideshow" />
